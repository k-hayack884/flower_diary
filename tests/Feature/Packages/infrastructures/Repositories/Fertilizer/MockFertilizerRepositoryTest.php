...
class MockFertilizerRepositoryTest extends TestCase
{
    ...
    public function test_設定IDから検索して情報を取得する()
    {
        ...
        $this->assertSame($fertilizerSettingId->getId(), $fertilizerSetting->getFertilizerSettingId());
    }
    ...
    public function test_設定を追加する()
    {
        ...
        $this->mockFertilizerRepository->save($addFertilizerSetting);

        $fertilizerSettingId = new FertilizerSettingID('114c5142-7a0d-40b0-af6e-30bff5975e31');
        $fertilizerSetting = $this->mockFertilizerRepository->findById($fertilizerSettingId);
