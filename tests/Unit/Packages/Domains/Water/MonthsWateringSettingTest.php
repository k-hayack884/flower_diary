...
class MonthsWateringSettingTest extends TestCase
{
private WaterSettingId $waterSettingId;
    ...
    public function test_期間を設定できる()
    {
        ...
        $setting=new MonthsWaterSetting($this->waterSettingId,$tarm,$this->note,$this->waterAmount,$this->wateringTimes,$this->wateringInterval);
        $this->assertInstanceOf(MonthsWaterSetting::class,$setting);
    ...
    public function test_期間の編集をする()
    {
        ...
        $this->assertInstanceOf(MonthsWaterSetting::class,$updatedSetting);
